  ...
  return (
    <div className="text-[#ADB7B3]">
      ...
      <div className="flex flex-col">
          ...
          <div className="flex flex-col gap-2">
            <label>
              <input
                ...
                onChange={() => handleCheckboxChange("Moins de 18 ans", "age")}
              />
          ...
          <div>
            ...
            <label className="flex flex-col">
              ...
              <input
                ...
                onChange={() =>
                  handleCheckboxChange("aime pas le rugby", "aime pas le rugby")
                }
              />
            </label>
          </div>
        ...
        <label className="flex flex-col">
          Êtes-vous favorable à installation d'infrastructure pour la praztique
          du rugby dans notre ville ?
          <select
        ...
        <label>
          ...
          <div>
            <label className="flex flex-col">
              ...
              <input
                type="checkbox"
                checked={state.desiredEventTypes.includes("Tournois de rugby")}
                onChange={() =>
                  handleCheckboxChange("Tournois de rugby", "desiredEventTypes")
                }
              />
            </label>
